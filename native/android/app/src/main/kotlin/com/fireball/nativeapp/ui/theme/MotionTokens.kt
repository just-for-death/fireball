...
/**
 * M3 Expressive motion tokens — verbatim port of
 * `app/.../ui/theme/MotionTokens.kt`. Single source of truth for durations,
 * easing and spring specs across both Android and Desktop.
 */
object MotionTokens {
